...
const AdultDetails: React.FC = () => {
  const navigate = useNavigate();

  const handleSubmit = (data: any) => {
    // Here we would typically store the data in state management or API
    console.log("Adult details:", data);
    navigate("/family/income-information");
  };
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex-1">
          <p className="text-gray-600 mb-6">
            Enter information below to personalize your experience. Your data is safe.
          </p>
