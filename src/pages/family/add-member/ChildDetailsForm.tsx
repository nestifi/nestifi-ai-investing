...
const ChildDetailsForm = () => {
  ...
  const handleContinue = () => {
    ...
    sessionStorage.setItem("childProfile", JSON.stringify({
      firstName,
      lastName,
      dob,
      gender,
  ...
  return (
    <div className="min-h-screen bg-white p-4">
      <div className="max-w-md mx-auto pt-8">
        <h1 className="text-2xl font-bold mb-6">Child Details</h1>
        <p className="text-gray-600 mb-8">
          Please provide the details for the child member
        </p>
